    ...
    public class AutomapperProfiles : Profile
    {
        public AutomapperProfiles(GeometryFactory geometryFactory)
        {
            ...
            CreateMap<PeliculaCreacionDTO, Pelicula>()
                ...
                .ForMember(x => x.PelculasGeneros, ocpciones => ocpciones.MapFrom(MapearPeliculasGeneros))
                .ForMember(x => x.PeliculasCines, ocpciones => ocpciones.MapFrom(MapearPeliculasCines))
                .ForMember(x => x.PeliculasActores, ocpciones => ocpciones.MapFrom(MapearPeliculasActores));
        ...
        private List<GeneroDTO> MapearPeliculasGeneros(Pelicula pelicula, PeliculaDTO peliculaDTO)
        {
            ...
            if(pelicula.PelculasGeneros != null)
            {
                foreach (var genero in pelicula.PelculasGeneros)
                {
